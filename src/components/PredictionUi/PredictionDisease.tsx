...
//         [[symptomVector]],
//         [1, 1, mlbClasses.length]
//       );
//       const prediction = model.predict(inputTensor) as tf.Tensor;
//       const predictionData = await prediction.data();
//       const predictedIndex = Array.from(predictionData).indexOf(
//         Math.max(...Array.from(predictionData))
//       );
//       const predictedDisease =
//         mlbClasses[predictedIndex] || "Unknown condition";
...
//       const llmResponse = await consultMedicalLLM(
//         userMessage,
//         tfPrediction || undefined
//       );
...
//           role: "assistant",
//           content:
//             "I apologize, but I encountered an error processing your request. Please try again or consult a healthcare professional.",
//         },
//       ]);
//     } finally {
//       setIsLoading(false);
...
//               <h2 className="text-xl  mb-4 text-violet-500 font-bold">
//                 AI Medical Assistant
//               </h2>
...
//                     The AI assistant will still work using the LLM model.
//                   </p>
//                 </div>
//               )}
...
//                       Describe your symptoms and I&apos;ll provide helpful
//                       medical information.
//                     </p>
//                     <p className="mt-1 text-xs text-gray-400">
//                       Remember: Always consult healthcare professionals for
//                       proper diagnosis.
//                     </p>
//                   </div>
//                 )}
...
//                 ⚠️ This is for informational purposes only. Always consult
